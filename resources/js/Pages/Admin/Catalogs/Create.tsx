...
export default function Create({ categories }: { categories: Category[] }) {
    const { data, setData, post, processing, errors } = useForm({
        catalog_category_id: '' as string | number,
        title: '',
        description: '',
    ...
    const [specsList, setSpecsList] = useState<SpecItem[]>([
        { name: 'Sertifikasi', value: 'SNI Certified' },
        { name: 'Bahan Konduktor', value: '100% Tembaga Murni' },
        { name: 'Garansi', value: '10 Tahun' }
    ]);
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Tambah Katalog Baru</h2>
                    <Link
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Kabel NYY 2x1.5mm"
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                                />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Tuliskan kegunaan utama dan keunggulan kabel ini..."
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                                />
                            ...
                            <div className="flex justify-end space-x-3">
                                ...
                                >
                                    {processing ? 'Menyimpan...' : 'Simpan Katalog'}
                                </button>
                            </div>
                        </form>
                    </div>
